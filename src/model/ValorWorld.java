...
import model.space.valor_activity.PlainSpaceActivity;
import model.space.valor_activity.SpaceFactory;
...
public class ValorWorld {
    ...
    public ValorWorld() {
        ...
        // setup markets
        markets = new Market[] { new RandomMarketFactory().createMarket(), new RandomMarketFactory().createMarket(),
                new RandomMarketFactory().createMarket(), new RandomMarketFactory().createMarket(),
                new RandomMarketFactory().createMarket(), new RandomMarketFactory().createMarket(),
                new RandomMarketFactory().createMarket(), new RandomMarketFactory().createMarket() };
